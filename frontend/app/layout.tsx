...
export const metadata: Metadata = {
  ...
  description: 'The first PHP 8.4 framework with a full AI orchestration engine built in. 28 packages, compiled DI, property hooks. Faster than Laravel and Symfony.',
  ...
  openGraph: {
    ...
    description: 'Multi-model routing, pipelines, guardrails, and agent crews in one Composer package. 28 PSR-compliant packages. 6× faster than Laravel at 18% the memory.',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Attribute-first PHP 8.4 framework with built-in AI orchestration, compiled DI, and 28 PSR-compliant packages.',
              url: 'https://monkeyslegion.com',
